...
// Base response schema with timestamp
export const BaseResponseSchema = Type.Object(
  {
    timestamp: Type.String({ description: 'PST-formatted timestamp' }),
  },
  { $id: 'BaseResponse' },
);

export const EstimateGasResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
...
export const TokensResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
      tokens: Type.Array(
...
export const PollResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
...
export const StatusResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
      chain: Type.String(),
...
export const AllowancesResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
      spender: Type.String(),
...
export const ApproveResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
...
export const WrapResponseSchema = Type.Intersect([
  BaseResponseSchema,
  Type.Object(
    {
      nonce: Type.Number(),
